            ...
            <div className={styles.container}>
                <div className={styles.header}>
                    <h1 className={styles.title}>
                        <span className={styles.titleLine}>Session Results</span>
                    </h1>
                    <p className={styles.subtitle}>Summary of your training performance</p>
                </div>

                <div className={styles.grid}>
                    <div className={styles.mainColumn}>
                        {/* Performance Overview */}
                        <Card className={styles.setupCard} title="Performance Overview">
                        ...
                        {/* Snapshots Gallery */}
                        <Card className={styles.setupCard} title="Captured Snapshots" subtitle={`${snapshots.length} images saved`}>
                            {snapshots.length === 0 ? (
                    ...
                    <div className={styles.sideColumn}>
                        {/* Session Info */}
                        <Card className={styles.setupCard} title="Session Details">
                        ...
                        {/* Export Options */}
                        <Card className={styles.setupCard} title="Export Options">
